...
public class RobotService30Verticle extends AbstractVerticle {
    static final Logger LOGGER = LoggerFactory.getLogger(RobotService30Verticle.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
      ...
      .flatMap(openapiRouter -> {
        ...
        server = vertx.createHttpServer(new HttpServerOptions().setPort(9669).setHost("localhost"))
      ...
      return server.listen()
          .onSuccess(server -> LOGGER.info("RobotService30Verticle started on port " + server.actualPort()));
      })
